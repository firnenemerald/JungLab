...
# Create additional windows for intermediate steps
...
while True:
    ...
    if largest_contour is not None:
        ...
        # Draw largest contour on black_mask visualization
        ...
        bbox_region_display = cv2.cvtColor(bbox_region, cv2.COLOR_GRAY2BGR)
        if chosen_darker_contour is not None:
            # Draw chosen darker contour in the bbox region space
            cv2.drawContours(bbox_region_display, [chosen_darker_contour], -1, (0, 255, 255), 2)
